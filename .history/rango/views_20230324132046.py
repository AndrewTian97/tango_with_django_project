...
class ShowCategory(View):
    ...
    def basic_process(self, category_name_slug):
        context_dict = {}
        try:
    ...
    def get(self, request, category_name_slug):
        ...
        context_dict = self.basic_process(category_name_slug)
        
        return render(request, 'rango/category.html', context=context_dict)
    
    def post(self, request, category_name_slug):
        
        context_dict = self.basic_process(category_name_slug, context_dict)
